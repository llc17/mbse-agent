...
class CompletenessCheck(BaseModel):
    """需求完整性检查结果。"""
    is_complete: bool = Field(description="是否信息充足可以开始建模")
    missing_fields: list[str] = Field(default_factory=list, description="仍缺失的信息")
    suggestions: list[str] = Field(default_factory=list, description="建议澄清的问题")
